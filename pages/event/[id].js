...
import { TextField, Button, Paper, List, ListItem, ListItemText } from "@material-ui/core";
...
const Event = (props) => {
  ...
  const [organizer_email, setOrganizerEmail] = React.useState(props.organizer_email)
  const [google_meet_link, setGoogleMeetLink] = React.useState(props.google_meet_link)
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <Paper className={styles.card}>
          ...
          <Button disabled={ out_description || out_entity || out_google_meet_link || out_organizer_email|| out_zoom_link } onClick={formHandler} variant="contained">
            Aplicar alterações
          </Button>
        </Paper>
        <Paper className={styles.card}>
...
export const getServerSideProps = async (context) => {
    ...
    const res = await axios.get(`${url_prefix}/api/getEvent?unique_id=${unique_id}`);
